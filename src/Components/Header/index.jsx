      ...
      <header className="m-0 p-0 w-full h-14 px-6 py-6 flex items-center text-white font-inter text-sm leading-snug font-semibold bg-primary_500_brand">
        <div className="m-0 p-0 w-full flex justify-between">
          <div className="m-0 p-0 flex items-center gap-8">
            <img className="m-0 p-0 logo cursor-pointer" src={Logo} alt="logo" />
          ...
          <div className="flex items-center gap-4 ml-auto">
            ...
            <div className="flex w-max gap-2 items-center">
              <Avatar src={Avatar_profile} alt="avatar" size="sm" className='cursor-pointer' />
              <Menu open={openMenu} handler={setOpenMenu} allowHover>
                ...
                <MenuList className='shadow-none m-0 px-0 py-0 gap-[10px] text-neutral_800 w-[276px] border-solid border-neutral_300'>
                  <MenuItem className="flex items-start px-[10px] py-[10px] hover:text-primary_500_brand">
                    <Typography variant="small" className="font-medium font-inter text-xs">
                  ...
                  >
                    <MenuHandler className="flex items-center justify-between m-0 px-[10px]">
                      <MenuItem className="flex items-start px-[10px] py-[10px] hover:text-primary_500_brand">
                        ...
                        <ChevronUpIcon
                          strokeWidth={2.5}
                          className={`h-3.5 w-3.5 transition-transform ${openSubMenu ? "rotate-90" : ""
                            }`}
                        />
                      </MenuItem>
                    </MenuHandler>
                    <MenuList className='shadow-none m-0 px-0 py-0 gap-[10px] text-neutral_800 max-h-72 w-[205px] border-solid border-neutral_300'>
                      <MenuItem className="flex items-start px-[10px] py-[10px] justify-center">
                        <Typography variant="small" className="font-medium font-inter text-xs">
                          Projects (2)
                        </Typography>
                      </MenuItem>
                      ...
                      <hr className="border-1/2 border-solid border-neutral_300" />
                      <MenuItem className="flex items-start px-[10px] py-[10px] justify-center hover:text-primary_500_brand text-neutral_700 bg-neutral_100">
                        <Typography variant="small" className="font-medium font-inter text-xs">
                          Create project
                        </Typography>
                      </MenuItem>
                  ...
                  <MenuItem disabled className="flex items-start px-[10px] py-[10px]">
                    <Typography variant="small" className="font-medium font-inter text-xs">
                      Shortcuts
                    </Typography>
                  </MenuItem>
                  ...
                  <hr className="border-1/2 border-solid border-neutral_300" />
                  <MenuItem className="flex items-start px-[10px] py-[10px] mb-[10px] hover:text-primary_500_brand">
                    <Typography variant="small" className="font-medium font-inter text-xs ">
                      Log out
                    </Typography>
                  </MenuItem>
